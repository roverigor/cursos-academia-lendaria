...
Este curso usa **Bolt.new (Lovable)**, mas você pode adaptar para outras ferramentas similares:

- **v0.dev** (Vercel) - Similar ao Bolt, também gera código com IA
- **Replit Agent** - Roda código direto no navegador, bom pra Python
- **Cursor** - Editor local com IA integrada (mais avançado)

**Por quê recomendamos Bolt pro curso:**
- ✅ Deploy automático (não precisa configurar nada)
- ✅ Interface visual clara (perfeito pra iniciantes)
- ✅ Integração Supabase simplificada (3 passos!)

**Depois do curso:** Sinta-se livre pra testar outras ferramentas e descobrir qual você prefere. O conhecimento que você ganha aqui (estrutura, lógica, integrações) funciona em qualquer plataforma no-code.
...
**Assistir as lessons:** ✅ Sim (leitura de markdown)
**Bolt.new:** ⚠️ Melhor no desktop (interface complexa precisa de tela maior)
**Supabase:** ✅ Sim (dashboard funciona bem no mobile)

**Recomendação Estratégica:**
- **Lê as lessons no celular** quando tiver tempo morto (ônibus, fila, espera)
- **Faz os projetos no desktop/notebook** (Bolt precisa de tela maior pra conforto)

**Por quê isso importa?** Estudos mostram que alunos que usam mobile para consumir teoria e desktop para prática **completam 45% mais rápido** que os que só usam desktop.

---

## 👥 Encontre Seu Course Buddy

Olha só, vou te contar uma parada.
...
3. Combine: 1 lesson por dia, check-in no grupo quando terminar

**Por quê funciona:**
- Alguém te cobra se você parar (accountability)
- Vocês desbugam problemas juntos (troubleshooting colaborativo)
- Motivação em dobro (celebração compartilhada)

**Sozinho você pode ir rápido. Com alguém, você vai longe.**
...
Gamifica tua jornada! Marca conforme completa:

### **🎨 Nível 1: Primeiro Contato**
- [ ] **Quebrador de Barreiras** - Completou Lesson 1.1 (Casa FullStack dominada)
- [ ] **Primeiro App** - Criou o Mapa da Clareza funcionando (Lesson 1.2)
- [ ] **Publicado!** - Fez deploy de site no Bolt.new (Lesson 2.1)

### **🗄️ Nível 2: Arsenal Completo**
- [ ] **Database Master** - Salvou dados no Supabase (Lesson 2.2)
- [ ] **Auth Hero** - Implementou login/cadastro completo (Lesson 2.3)
- [ ] **CRUD Warrior** - App com Create, Read, Update, Delete funcionando

### **💰 Nível 3: Monetização**
- [ ] **First Revenue** - Integrou Stripe no modo teste (Lesson 3.1)
- [ ] **MicroSaaS Builder** - Hub de GPTs completo rodando (Lesson 3.1)
- [ ] **Sales Machine** - Landing page com funil funcionando (Lesson 3.2)

### **🎓 Nível 4: Graduação**
- [ ] **Vibecoding Graduate** - Completou 100% do curso (todas as lessons)
- [ ] **Project Champion** - Submeteu MicroSaaS final (Projeto Final)
- [ ] **Community Hero** - Ajudou 3+ pessoas no grupo (pague pra frente!)

---

### **🌟 Conquistas Bônus (Opcional)**

- [ ] **Speed Runner** - Completou o curso em menos de 2 horas
- [ ] **Perfectionist** - Tirou 90+ em todos os quizzes
- [ ] **Entrepreneur** - Fez primeiro cliente real (R$ 500+)
- [ ] **Revenue King** - MicroSaaS com primeiro pagamento recorrente
- [ ] **Teacher** - Ensinou alguém a usar Bolt/Supabase

---

### **💬 Compartilha no LinkedIn:**

Quando completar, posta:

> "Acabei de completar o curso **Vibecoding**! 🚀
> Criei 6 apps funcionais em 2 horas, sem escrever 1 linha de código.
> Bolt.new + Supabase + IA = autonomia total pra criar qualquer app.
