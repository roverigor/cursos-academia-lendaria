#  The Keys To Success  [ __](javascript:void\(0\); "Add to my favorites")

You make new discoveries by figuring things out for yourself.

No matter what information I give you throughout this course, you have to
develop the crucial skill of "figuring it out."

That is how you create the most value. If I can teach it to you, I can teach
it to others.

Your job is to take everything I say here, _understand it through direct
experience_ , and _create_ a way of doing things that is unique to you.
...
> execution.
>
> — DAN KOE (@thedankoe) [May 5,
> 2022](https://twitter.com/thedankoe/status/1522144576768823296?ref_src=twsrc%5Etfw)

Life becomes more meaningful when you can connect everyday thoughts,
experiences, information, and stimuli to a project.

In other words, you are nerobiologically rewarded with dopamine and other
chemicals when you apply what you learn.

A personal brand is a giant project that allows you to test, understand, and
practice everything you learn.

Throughout this course, we will be focused on the principles and fundamentals
of any given skill. Your job is to implement _immediately_ by applying that
...
understood what you are currently aware of — otherwise it stays in your head
and causes random problems that you are unconscious of.
...
An example of this process for **creating a beautiful profile picture or
header image** would be:

  * Research graphic design or headshot photography principles or basics on YouTube — take notes on the _levers_ you can pull with the least amount of effort to get the best results
...
Visualize the end result, outline the project, and research to solve problems
along the way to create your first iteration of a project.
...
Get in the habit of starting projects that you have no idea how to complete
...
When you applied what you've learned in a public setting, you are documenting
...
Think of your idea generation, content curation and synthesis, life
experiences, and creations that stem from those as documentation.
...
All of these things will hold more value than you could ever imagine in 2-3
years.

People remember the ideas that you introduced them to and how it changed their
life (most won't explicitly tell you this until years later).

People will get massive results from your product and praise you for your
work.

Your products, content, brand, and life will improve with each and every
iteration.
...
Write all ideas, thoughts, and steps down as you come across them. We will
have a place to document all of these things in the Notion Command Center that
comes with the Bachelors curriculum.
