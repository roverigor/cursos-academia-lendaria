#  Creating Fusion Content  [ __](javascript:void\(0\); "Add to my favorites")

As your database grows in size, complexity, and impact you can start to treat
your discoveries, theories, and processes as building blocks for your long-
form content.
...
This is what completely changed the game for me in my content creation
process.
  ...
  * I could visualize these concepts and start having an incredibly unique content style

I want to revisit the APAG framework and the long-form writing template now
that we have more ideas to pull from.
