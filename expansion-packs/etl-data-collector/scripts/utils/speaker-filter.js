 ...
 */
export function calculateSpeakerStats(utterances) {
  const stats = {};
 ...
 */
export function identifyTargetSpeaker(utterances, options = {}) {
  const {
    rules = {
 ...
 */
export function filterByTargetSpeaker(utterances, targetSpeaker) {
 ...
 */
export function formatTranscriptMarkdown(utterances, options = {}) {
  const {
    showSpeakers = true,
    showTimestamps = true,
 ...
 */
export function extractTopics(utterances) {
