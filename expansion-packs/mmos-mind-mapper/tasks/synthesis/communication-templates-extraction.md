...
inputs:
  required:
    - artifacts/communication_patterns.md
    - quotes/signature_phrases.md
  dependencies:
    - quote-extraction task completed
    - phrase-mining task completed

outputs:
  primary:
    - templates/communication_frameworks.yaml
  format: yaml
