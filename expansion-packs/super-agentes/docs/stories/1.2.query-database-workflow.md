...
- [ ] Integrate db-query-optimization for suggestions (AC: 6)
...
│   └── db-query-optimization.md             # Optimization suggestions
└── docs/
...
- Well-integrated with existing tasks (db-run-sql, db-explain, db-query-optimization)
