...
🟡 **Status:** Inferred from 22 lessons (75% avg confidence - review recommended)

**Objetivos do Curso:**

1. **Develop advanced Properties Metadados Poderosos workflows**
   - Bloom's Level: Create
   - Source: 3.3-properties-metadados-poderosos.md, 6.4-os-4-niveis-de-maestria-e-proximos-passos.md
   - Confidence: 80%

2. **Evaluate decision making effectively**
   - Bloom's Level: Evaluate
   - Source: 2.2-tipos-de-notas-e-quando-usar.md, 1.1-por-que-voce-precisa-de-um-segundo-cerebro.md, 1.2-por-que-obsidian-e-a-escolha-definitiva.md
   - Confidence: 80%

3. **Use Install and configure Ai successfully on Configuracoes Essencis E Interface**
   - Bloom's Level: Apply
   - Source: 1.4-configuracoes-essenciais-e-interface.md
   - Confidence: 80%

4. **Explain core concepts effectively**
   - Bloom's Level: Understand
   - Source: 5.3-smart-connections-converse-com-seu-cerebro.md, 6.1-workflows-diarios-do-caos-a-clareza.md, 6.3-importando-de-outras-ferramentas.md + 13 more
   - Confidence: 60%
