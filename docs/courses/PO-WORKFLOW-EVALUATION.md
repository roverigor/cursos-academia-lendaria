...
- Adicionar link no top do template:
  ```
  📚 Ver exemplo completo: docs/courses/vibecoding/COURSE-BRIEF-FILLED.md
  ```
...
Ver roadmap completo em: docs/courses/MELHORIAS-FUTURAS-RESUMO.md
...
1. **Atualizar:** `expansion-packs/creator-os/tasks/generate-course.md`
   ...
   **Substituir Step 1.1 (Interactive Elicitation):**
   ...
   brief_initialization:
     ...
     actions:
       1. Check if folder exists: docs/courses/{course_slug}/
       2. If not exists:
          - Create folder structure
          - Copy: expansion-packs/creator-os/templates/course-brief.md
          - Save as: docs/courses/{course_slug}/COURSE-BRIEF.md
       3. Notify user:
          - "📋 COURSE-BRIEF.md created at: docs/courses/{course_slug}/"
...
2. **Criar novo task:** `expansion-packs/creator-os/tasks/continue-course.md`
   ...
   steps:
     1_load_brief:
       - Load: docs/courses/{course_slug}/COURSE-BRIEF.md
       - Parse 8 sections
...
2. Ou criar: `docs/courses/EXAMPLE-COURSE-BRIEF-filled.md`
...
→ `docs/courses/MELHORIAS-FUTURAS-RESUMO.md`
...
|---------|------------------|------------|
| **Cursos criados com v2.0** | 5+ | Count in /docs/courses/ |
