...
| `sources_master.yaml.bak` | `docs/minds/sam_altman/sources/` | Backup |
| `launcher-spec.md.bak` | `docs/mmos/architecture/` | Backup |
| `Gemini Result 2.md` | `docs/minds/steven_pinker/sources/research/` | Cópia |
| `System Prompt - l0z4n0 2.0 (1).md` | `docs/minds/joao_lozano/sources/custom/` | Cópia confusa |
| `165_copy_what_you_like.md` | `docs/minds/paul_graham/sources/articles/markdown/` | "copy" no nome |
...
.aios-core/.DS_Store
.claude/.DS_Store
docs/minds/alan_nicolas/.DS_Store
docs/minds/andrej_karpathy/.DS_Store
... (22 mais)
```
...
### 3.8 🚨 Estrutura Inconsistente em docs/minds/
...
git rm "docs/minds/sam_altman/sources/sources_master.yaml.bak"
