...
required_inputs:
  ...
  - analysis/quotes_database.yaml (citações sobre crenças e visões de mundo)
  - analysis/values_hierarchy.yaml (valores para contextualização)
  - analysis/life_timeline.yaml (evolução temporal de crenças)
```
...
**ENTREGUE**: analysis/beliefs_core.yaml com sistema completo de crenças seguindo exatamente este formato.