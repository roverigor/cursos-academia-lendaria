...
- `collect-blog.js` - Blogs (✅ PROVEN: 100% success on Sam Altman - 30/30 posts)
...
### ✅ Phase 1: Blog Collection (COMPLETE)
...
### ✅ Phase 2: YouTube Collection (COMPLETE)
...
### ✅ Phase 3: PDF Collection (COMPLETE)
...
### ✅ Phase 4: Unified Orchestrator (COMPLETE)
...
### ⏳ Phase 5: MMOS Integration (PENDING)
...
├── bin/                      ✅ NEW STRUCTURE
│   ├── collect-blog.js       ✅ COMPLETE
│   ├── collect-youtube.js    ✅ COMPLETE
│   ├── collect-pdf.js        ✅ COMPLETE
│   └── collect-all.js        ✅ COMPLETE
├── scripts/
│   ├── utils/
│   │   ├── blog-discovery.js    ✅ COMPLETE
│   │   └── youtube-discovery.js ✅ COMPLETE
│   ├── collectors/
│   │   ├── web-collector.js     ✅ Updated (slug support)
│   │   ├── youtube-collector.js ✅ Updated (no metadata.json)
│   │   ├── pdf-collector.js     ✅ Updated (no metadata.json)
│   │   └── ...
│   └── orchestrator/
│       └── parallel-collector.js ✅ Updated (outputDir pattern)
└── docs/
    └── BLOG_DISCOVERY.md     ✅ COMPLETE

expansion-packs/mmos/
└── tasks/
    └── research-collection.md 🔨 TO UPDATE
```
...
console.log(`✅ ${validation.valid}/${sources.length} collected`);
```

### Smart Rules (Blog Discovery)
1. **Featured Posts** - If blog has TOP/featured → collect only those
2. **Recent Posts** - If no featured → collect last 3 years
3. **Small Blogs** - If total < 50 posts → collect 100%
...
- ✅ `collect-blog.js` created and tested
- ✅ Validated with Sam Altman blog (30/30 posts, 100% success)
- ✅ Slug filenames working correctly
- ✅ Progress bar and validation integrated
- ✅ Documentation created (BLOG_DISCOVERY.md)

**Phase 2 Complete (2025-10-11):**
- ✅ `collect-youtube.js` created in `bin/`
- ✅ `youtube-discovery.js` utility created
- ✅ Supports single videos, channels, and playlists
- ✅ Smart rules: < 50 videos = 100%, else last 3 years
- ✅ yt-dlp integration for audio download
- ✅ AssemblyAI transcription with speaker diarization
- ✅ Progress tracking and validation built-in

**Phase 3 Complete (2025-10-11):**
- ✅ `collect-pdf.js` created in `bin/`
- ✅ Single PDF and batch modes supported
...
- ✅ `collect-all.js` unified orchestrator created in `bin/`
- ✅ Handles mixed source types (blog, youtube, pdf, podcast)
- ✅ Routes to appropriate collectors automatically
- ✅ Consolidated reporting by type
- ✅ Retry failed sources option (--retry-failures)
- ✅ Comprehensive validation with breakdown by type

**Scripts Reorganization (2025-10-11):**
- ✅ All collection tools moved to `bin/` directory
- ✅ Updated imports to use relative paths from bin/
...
**To Update:**
- `expansion-packs/mmos/tasks/research-collection.md`
- `expansion-packs/mmos/README.md`
...
**Story Status:** Phase 1 ✅ | Phase 2-6 ⏳
