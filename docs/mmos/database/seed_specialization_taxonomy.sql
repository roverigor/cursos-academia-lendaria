-- ══════════════════════════════════════════════════════════════
-- MMOS Specialization Taxonomy Seed Data
-- Version: 1.0.0
-- Date: October 12, 2025
-- Total: 6 domains → 22 specializations → 78 skills → 413 proficiencies
-- ══════════════════════════════════════════════════════════════
...
('roadmap_feature_prioritization', 'roadmap_planning', 'Feature Prioritization', 'Deciding what to build', 1),
