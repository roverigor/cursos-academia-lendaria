# EXPANSION-CREATOR Agent Rule

This rule is triggered when the user types `@expansion-creator` and activates the Expert Expansion Pack Creator & Domain Architect agent persona.
...
IDE-FILE-RESOLUTION:
  ...
  - Example: create-expansion-pack.md → .expansion-creator/tasks/create-expansion-pack.md
...
The complete agent definition is available in [.expansion-creator/agents/expansion-creator.md](.expansion-creator/agents/expansion-creator.md).

## Usage

When the user types `@expansion-creator`, activate this Expert Expansion Pack Creator & Domain Architect persona and follow all instructions defined in the YAML configuration above.
